...
add_action( "init", "custom_fields_localisation_taxonomies_init" );
...
function custom_fields_taxonomies_init() {
    ...
    $args = array(
        'label' => __( "Type annonces" ),
        'hierarchical' => true,
        'query_var' => true,
        'rewrite' => array('slug' => 'type-annonce')
    );

    register_taxonomy( 'type_annonce', 'advert', $args );
...
function custom_fields_localisation_taxonomies_init() {
    ...
    register_taxonomy( 'localisation', 'advert', $args );
    ...
    wpadverts_custom_fields_register_data_source(array(
        "name" => "localisation",           
        "title" => "localisation",                   
        "callback" => "custom_fields_localisation_taxonomies_data_source",
...
/**
 * Data source function for type-annonce data source.
 * 
 * This function will return all options created for type_annonce, note 
...
function custom_fields_taxonomies_data_source() {
    return adverts_taxonomies( 'type_annonce' );
}

function custom_fields_localisation_taxonomies_data_source() {
    return adverts_taxonomies( 'localisation' );
}
