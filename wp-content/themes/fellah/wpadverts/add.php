...
<div class="pub_annonce">
    <form action="" method="post" class="adverts-form <?php echo $form->get_layout() ?>">
        <fieldset>
            ...
            <?php endforeach; ?>
            <div class="adverts-control adverts-field-name-submit">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4"> 
                            <input type="submit" name="submit" value="<?php _e("Send my ad", "fellah") ?>" style="font-size:1.2em" class="adverts-cancel-unload" />
                        </div> 
                        <div class="col-md-12">
                            <p>
