...
class Personalize_Login_Plugin {
	...
	public function render_login_form( $attributes, $content = null ) {
		...
		if ( is_user_logged_in() ) {
			return '<div class="center">' . __( 'You are already signed in.', 'personalize-login' ) . '</div>';
		}
	...
	public function replace_retrieve_password_message( $message, $key, $user_login, $user_data ) {
		...
		$msg .= "<a href='" . site_url( "wp-login.php?action=rp&key=$key&login=" . rawurlencode( $user_login ), 'login' ) . "'" . site_url( "wp-login.php?action=rp&key=$key&login=" . rawurlencode( $user_login ), 'login' ) . "</a>" . "\r\n\r\n";
